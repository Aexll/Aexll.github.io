...
exports.TrackingModeExitMode = exports.TickMarkType = exports.PriceScaleMode = exports.PriceLineSource = exports.LineType = exports.LineStyle = exports.LastPriceAnimationMode = exports.LasPriceAnimationMode = exports.CrosshairMode = exports.ColorType = void 0;
exports.createChart = Ls;
exports.isBusinessDay = vn;
exports.isUTCTimestamp = _n;
exports.version = Es;
...
var c = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
    ...
    _ = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
    d = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?[\d]{0,10}(?:\.\d+)?)\s*\)$/;

function w(t) {
  var i;
  if ((t = t.toLowerCase()) in o && (t = o[t]), i = d.exec(t) || _.exec(t)) return [l(parseInt(i[1], 10)), l(parseInt(i[2], 10)), l(parseInt(i[3], 10)), f(i.length < 5 ? 1 : parseFloat(i[4]))];
  if (i = v.exec(t)) return [l(parseInt(i[1], 16)), l(parseInt(i[2], 16)), l(parseInt(i[3], 16)), 1];
  if (i = c.exec(t)) return [l(17 * parseInt(i[1], 16)), l(17 * parseInt(i[2], 16)), l(17 * parseInt(i[3], 16)), 1];
    ...
    if (null !== this.Bt) {
      ...
      if (e || u) {
        ...
        var a = Math.round(this.Bt.tt * i),
            ...
            l = Math.ceil(this.Bt.Ft * i),
            f = Math.ceil(this.Bt.Ot * i);
...
exports.CrosshairMode = Y;
!function (t) {
  t[t.Normal = 0] = "Normal", t[t.Magnet = 1] = "Magnet";
}(Y || (exports.CrosshairMode = Y = {}));
...
var ot = function (t) {
  ...
  return m(i, t), i.prototype.Z = function (t) {
    ...
    if (null !== this.X && 0 !== this.X.G.length && null !== this.X.J) if (t.lineCap = "butt", t.lineWidth = this.X.Vt, s(t, this.X.Pt), t.strokeStyle = this.zn(t), t.lineJoin = "round", 1 === this.X.G.length) {
      t.beginPath();
      var i = this.X.G[0];
...
var bt = function () {
  ...
  function i(i, n) {
    ...
    return s.zt = new F(), s._s = new lt(), s.ds = new ct(), s.zt.U([s._s, s.ds]), s;
  }
    ...
    if (null !== this.Bt && 0 !== this.Bt.an.length && null !== this.Bt.J) {
      ...
      for (var h = null, r = this.bs <= this.Ms && this.Bt.ws >= Math.floor(1.5 * i), e = this.Bt.J.from; e < this.Bt.J.to; ++e) {
        ...
        if (r) {
          if (this.Bt.Ns) {
            var m = o - b,
                p = Math.max(d, Math.round(u.xs * i) - a),
                g = p + f - 1;
...
var Dt = function (t) {
  ...
  function i(i, n) {
    var s = t.call(this, i, n) || this;
    return s.Os = new Dt(), s.Vs = new At(), s.ut = new F(), s.ut.U([s.Os, s.Vs]), s;
  }
  ...
  return m(i, t), i.prototype.dt = function (t, i) {
    ...
    var s = this.Kn.W();
    this.Jn();
    var h = this.Kn.Ct().xt(s.baseValue.price, n.St),
        r = this.Xn.bt().ws();
    return this.Os.Z({
      G: this.Yn,
      Bs: s.topFillColor1,
  ...
  return t.prototype.Z = function (t) {
    ...
    if (null !== this.Bt) {
      ...
      for (var e = Math.floor(.5 * r), u = null, a = n.from; a < n.to; a++) {
        ...
        var l = Math.round(Math.min(o.xs, o.Cs) * s),
            f = Math.round(Math.max(o.xs, o.Cs) * s),
            c = Math.round(o.ys * s),
            v = Math.round(o.ks * s),
    ...
    if (null !== this.Bt) for (var r = "", e = this.Is(h), u = null, a = n.from; a < n.to; a++) {
      ...
      var l = Math.round(o.tt * h) - Math.floor(.5 * this.Ms),
          f = l + this.Ms - 1,
          c = Math.round(Math.min(o.xs, o.Cs) * h),
          v = Math.round(Math.max(o.xs, o.Cs) * h);
      if (null !== u && (l = Math.max(u + 1, l), l = Math.min(l, f)), this.Bt.ws * h > 2 * e) j(t, l, c, f - l + 1, v - c + 1, e);else {
        var _ = f - l + 1;
    ...
    if (null !== this.Bt) for (var h = "", r = this.Is(s), e = n.from; e < n.to; e++) {
      var u = i[e],
          a = Math.round(Math.min(u.xs, u.Cs) * s),
          o = Math.round(Math.max(u.xs, u.Cs) * s),
...
function ui(t, i, n, s, h, r, e, u, a) {
  var o = N(n) ? n : n.close,
      l = N(n) ? n : n.high,
      f = N(n) ? n : n.low,
      c = N(i.size) ? Math.max(i.size, 0) : 1,
      v = Qt(u.ws()) * c,
      _ = v / 2;
...
var ai = function () {
  ...
  return t.prototype.Gr = function () {
    ...
    var s = null,
        ...
        a = Math.min(i, r),
        o = 30 * Math.ceil(e / 30),
        l = Math.max(o, 30 * Math.floor(a / 30)),
        f = this.oe(e),
...
var gi = function (t) {
  function i(i, n, s) {
    ...
    var r = new li(h);
    return h.Ei = [r], h.Vr = new jt(r, h, i), "Area" !== s && "Line" !== s && "Baseline" !== s || (h.we = new Zt(h)), h.ye(), h.ke(), h;
  }
  ...
  return m(i, t), i.prototype.g = function () {
    ...
    var n = "Line" === this.ge || "Area" === this.ge || "Baseline" === this.ge || "Histogram" === this.ge ? [3] : [2, 1],
        s = this.Bt.he(t, i, n),
        h = null !== s ? new fi(s.ce, s.ve) : null;
  ...
  return t.prototype.Je = function (t, i, n) {
    ...
    var e = h.xt(t, r),
      ...
      if (null === e) return t;
      var u = a(s.kt());
      return t.concat([h.xt(e.St[3], u.St)]);
    }, []);
  ...
  return t.prototype.Z = function (t) {
    ...
    if (null !== this.Bt) {
      ...
      t.lineWidth = e;
      var a = Math.ceil(this.Bt.Ot * i),
          o = Math.ceil(this.Bt.Ft * i);
      !function (t, i) {
  ...
  return t.prototype.du = function (t, i) {
    ...
    if (null !== i) {
      var n = t.Yt(),
          s = this.Mu(n - 1, i),
          h = this.Mu(0, i),
          r = this._i.W().entireTextOnly ? this.gu() / 2 : 0,
          e = r,
          u = n - 1 - r,
          a = Math.max(s, h),
          o = Math.min(s, h);
...
var Ri = new et(),
  ...
  return t.prototype.Ke = function () {
    ...
    if (k(this.zi, t), this.Xe(), void 0 !== t.mode && this.$u({
      ...
      var i = e(t.scaleMargins.top),
          n = e(t.scaleMargins.bottom);
    ...
    if (!this.vr() && !this.Zu() && null !== this.Wu) {
      ...
      var i = (this.Wu + .2 * (this.xu - 1)) / (t + .2 * (this.xu - 1)),
          n = u(this.Su).mr();
    ...
    var n = u(this.Ar()),
        s = this.ha() + (this.na() - 1) * (t - n.pr()) / n.yr();
    return this.ea(s);
  }, t.prototype.Hu = function (t, i) {
    if (this.ra(), this.wi()) return 0;
    var n = this.ea(t),
        s = u(this.Ar()),
        h = s.pr() + s.yr() * ((n - this.ha()) / (this.na() - 1));
    ...
    if (null !== t) {
      ...
      if (h === this.Bu && r === this.Lu || (this.Bu = h, this.Lu = r, this.Pu = null, this.Ku()), null !== s) {
        ...
        this.Gu(s);
      } else null === this.Tr && (this.Gu(new fi(-.5, .5)), this.Ru = Oi(null));
  ...
  return t.prototype.Oa = function (t) {
    ...
    var n = p({
      ...
      autoScale: !0
        ...
        s = new ji(t, n, this.pi.W().layout, this.pi.W().localization);
...
var sn = function () {
  ...
  return t.prototype.W = function () {
    ...
    if (null !== this.tl) {
      var i = Nt(this.hh - t, 0, this.hh),
          n = Nt(this.hh - u(this.Wu), 0, this.hh);
...
exports.TrackingModeExitMode = hn;
!function (t) {
  t[t.OnTouchEnd = 0] = "OnTouchEnd", t[t.OnNextTap = 1] = "OnNextTap";
}(hn || (exports.TrackingModeExitMode = hn = {}));
  ...
  return t.prototype.Ce = function () {
    ...
    if (null !== e && null !== s && null !== h) {
      var u = e.Uh(r),
          a = s.So > h.So,
          o = null !== t && t > r && !a,
          l = u && this.Da.W().shiftVisibleRangeOnNewBar;
    ...
    var h = function (t, i, n) {
      var s = w(t),
          ...
          v = a[2],
          _ = a[3],
          d = [l(h + n * (o - h)), l(r + n * (c - r)), l(e + n * (v - e)), f(u + n * (_ - u))];
...
exports.ColorType = ln;
exports.PriceLineSource = on;
exports.LastPriceAnimationMode = exports.LasPriceAnimationMode = an;
...
}(an || (exports.LastPriceAnimationMode = exports.LasPriceAnimationMode = an = {})), function (t) {
  t[t.LastBar = 0] = "LastBar", t[t.LastVisible = 1] = "LastVisible";
}(on || (exports.PriceLineSource = on = {})), function (t) {
  t.Solid = "solid", t.VerticalGradient = "gradient";
}(ln || (exports.ColorType = ln = {}));
...
var yn = function () {
  ...
  return t.prototype.lc = function (t, i) {
    ...
    if (null !== this.Qf && null !== this.tc && !(i - this.Qf.rt > 50)) {
      var n = 0,
          s = gn(this.Qf, this.tc, this.ac),
          h = pn(this.Qf, this.tc),
          r = [s],
          e = [h];
...
var Sn = function () {
  ...
  return t.prototype.g = function () {
    ...
    if (null === i && 0 === t.touches.length && (i = t.changedTouches[0]), null !== i) {
      ...
      var n = this.Kc(t, i);
      if (this.Jc(n, this.Qc.pv), ++this.mc, this.gc && this.mc > 1) this.Zc(An(i), this.yc).Xc < 30 && !this.Dc && this.Jc(n, this.Qc.Gc), this.tv();else this.Dc || (this.Jc(n, this.Qc.gv), this.Qc.gv && Dn(t));
    ...
    if (0 === t.button) {
      ...
      if (!this.$c(t)) if (this.iv(i, this.Qc.yv), ++this.wc, this.Mc && this.wc > 1) this.Zc(An(t), this.bc).Xc < 5 && !this.Tc && this.iv(i, this.Qc.nv), this.sv();else this.Tc || this.iv(i, this.Qc.kv);
    }
...
var En = function () {
  ...
  return t.prototype.g = function () {
    ...
    var n,
        s = this;
    if (this.h_.has(i)) n = e(this.h_.get(i));else {
      ...
      var r = wn(t.canvas),
          u = Math.ceil(this.R / 4.5),
          a = Math.round(this.R / 10),
          o = Math.ceil(this.rh.Qt(t, i)),
          l = St(Math.round(o + 2 * u)),
          f = St(this.R + 2 * u),
          c = bn(document, new dn(l, f));
      n = {
        Gt: i,
  ...
  return t.prototype.g = function () {
    ...
    if (null !== this.o_ && null !== this._i && this._i.W().borderVisible) {
      ...
      var n,
          s = Math.max(1, Math.floor(this.F_().N * i));
    ...
    if (null !== this.o_ && null !== this._i) {
      ...
      var s = this.F_(),
          h = this._i.W().borderVisible && this._i.W().drawTicks,
          r = this.m_ ? Math.floor((this.o_.Ft - s.C) * i - s.N * i) : Math.floor(s.N * i),
...
var zn = function () {
  ...
  return t.prototype.g = function () {
    ...
    if (this.G_) {
      ...
      if (null !== this.ed && this.ed.xh(t.Yv, n), null === this.ed || this.ed.cc(n)) this.Ud();else {
        var s = this.pi(),
            h = s.bt(),
            r = this.ed,
            e = function () {
    ...
    if (this.ud) {
      if (this.Td(), document.activeElement !== document.body && document.activeElement !== document.documentElement) u(document.activeElement).blur();else {
  ...
  return t.prototype.g = function () {
    ...
    if (this.Hd()) {
      ...
      var s = Math.floor(this.cf.W().N * i),
...
var jn = function () {
  ...
  return t.prototype.g = function () {
    ...
    if (0 !== t) {
      ...
      n.clearRect(0, 0, Math.ceil(this.o_.Ft * s), Math.ceil(this.o_.Ot * s)), this.aw([this.ad.jt().Tf()], n, s);
    }
  }, t.prototype.j_ = function (t, i) {
    var n = this;
    q(t, i, function () {
  ...
  return t.prototype.jt = function () {
    ...
    var i = this._w[0],
        n = bn(document, new dn(this.hh, this.xu)),
        s = Mn(n),
        h = wn(n);
    return q(s, h, function () {
      ...
      var f = function (i) {
        var r = u("left" === i ? t.Nw.nw() : t.Nw.sw()),
            e = r.Ld(),
            a = r.Y_();
    ...
    for (s = n; s < i; s++) {
      (h = new zn(this, t[s])).Sd().u(this.zw.bind(this), this), this._w.push(h), this.pw.insertBefore(h.B_(), this.Nw.B_());
    }
    ...
    var r = this.jt().gf(),
        e = null !== r && r.kf instanceof gi ? r.kf : void 0,
...
var ls = function () {
  ...
  return t.prototype.g = function () {
    ...
    var n = this,
        ...
        h = !1,
        r = this.Zw.get(t);
    if (void 0 !== r) if (1 === this.Zw.size) s = !1, h = !0, this.Xw.clear();else for (var e = 0, a = this.Gw; e < a.length; e++) {
      a[e].pointData.Yw.delete(t) && (h = !0);
    }
    var o = [];
