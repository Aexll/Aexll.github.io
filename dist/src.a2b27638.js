...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/fancy-canvas/coordinate-space.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/lightweight-charts/dist/lightweight-charts.esm.production.js":[function(require,module,exports) {
"use strict";
...
var ln = function () {
  ...
  function t(t, i) {
    var n = this;
    this.oc = new Xi(0, 0), this.Jc = null, this.Gc = null, this.Qc = null, this.tv = !1, this.iv = new G(), this.nv = 0, this.hv = !1, this.sv = null, this.rv = !1, this.ev = null, this.dc = function () {
      return n.uv && n.hi().Lr();
    }, this.bc = function () {
      return n.uv && n.hi().Lr();
    }, this.av = t, this.uv = i, this.uv.Yo().tn(this.ov.bind(this), this, !0), this.lv = document.createElement("td"), this.lv.style.padding = "0", this.lv.style.position = "relative";
    var h = document.createElement("div");
    h.style.width = "100%", h.style.height = "100%", h.style.position = "relative", h.style.overflow = "hidden", this.fv = document.createElement("td"), this.fv.style.padding = "0", this.cv = document.createElement("td"), this.cv.style.padding = "0", this.lv.appendChild(h), this.pc = tn(h, new Xi(16, 16)), this.pc.subscribeCanvasConfigured(this.dc);
  ...
  return t.prototype.an = function () {
    null !== this.Jc && this.Jc.an(), null !== this.Gc && this.Gc.an(), this.yc.unsubscribeCanvasConfigured(this.bc), this.yc.destroy(), this.pc.unsubscribeCanvasConfigured(this.dc), this.pc.destroy(), null !== this.uv && this.uv.Yo().rn(this), this.Ac.an();
  }, t.prototype.Wc = function () {
    return f(this.uv);
  }, t.prototype.wv = function (i) {
    null !== this.uv && this.uv.Yo().rn(this), this.uv = i, null !== this.uv && this.uv.Yo().tn(t.prototype.ov.bind(this), this, !0), this._v();
    ...
    return null !== this.uv ? this.uv.Do() : 0;
  }, t.prototype.Co = function (t) {
    this.uv && this.uv.Co(t);
  }, t.prototype.mf = function (t) {
    if (this.uv) {
      var i = t.Xf,
          n = t.Zf;
      ...
      if (!i.j().Qt()) {
        ...
        if (u.pressedMouseMove && "touch" !== t.ic || (u.horzTouchDrag || u.vertTouchDrag) && "mouse" !== t.ic) {
          ...
          null !== this.Qc || this.Nv() || (this.Qc = {
            x: t.Hf,
            y: t.Yf
          }), null === this.Qc || this.Qc.x === t.Hf && this.Qc.y === t.Yf || this.tv || (a.Qt() || i.Io(this.uv, a, t.Zf), i.Ll(t.Xf), this.tv = !0), this.tv && (a.Qt() || i.Wo(this.uv, a, t.Zf), i.Bl(t.Xf));
        }
      }
    }
    ...
    if (null !== this.uv) {
      ...
      if (this.tv) {
        var n = this.uv.Di();
        i.Ro(this.uv, n), i.Fl(), this.Qc = null, this.tv = !1;
      }
    }
  }, t.prototype.qf = function (t) {
    if (this.hv = !0, null === this.sv && cn) {
      var i = {
        m: t.Xf,
        g: t.Zf
      };
    ...
    f("left" === i ? this.Jc : this.Gc).Pc(new Xi(t, this.oc.st));
    ...
    if (0 !== t && null !== this.uv) {
      ...
      var n = Ji(this.yc.canvas);
      n.clearRect(0, 0, Math.ceil(this.oc.ht * this.yc.pixelRatio), Math.ceil(this.oc.st * this.yc.pixelRatio)), this.zv(n, this.yc.pixelRatio);
    }
    ...
    return this.av.P().layout.backgroundColor;
  }, t.prototype.ov = function () {
    null !== this.uv && this.uv.Yo().rn(this), this.uv = null;
    ...
    for (var n = f(this.uv), h = this.hi().kl().ci(n), s = n.wt(), r = n.dt(), e = 0, u = h; e < u.length; e++) {
      var a = u[e];
      t.save();
      var o = a.I(s, r);
    ...
    for (var n = f(this.uv).zh(), h = 0, s = n; h < s.length; h++) {
      var r = s[h];
      this.Iv(r, t, i);
    }
    ...
    for (var h = f(this.uv), s = t.ci(h), r = h.wt(), e = h.dt(), u = h.ct().Ml(), a = null !== u && u.ml === t, o = null !== u && a && void 0 !== u.pv ? u.pv.Ou : void 0, l = 0, c = s; l < c.length; l++) {
      var v = c[l].I(r, e);
    ...
    if (null !== this.uv) {
      var t = this.av;
      t.P().leftPriceScale.visible || null === this.Jc || (this.fv.removeChild(this.Jc.Ec()), this.Jc.an(), this.Jc = null), t.P().rightPriceScale.visible || null === this.Gc || (this.cv.removeChild(this.Gc.Ec()), this.Gc.an(), this.Gc = null);
      var i = t.ct().jl();
      t.P().leftPriceScale.visible && null === this.Jc && (this.Jc = new fn(this, t.P().layout, i, "left"), this.fv.appendChild(this.Jc.Ec())), t.P().rightPriceScale.visible && null === this.Gc && (this.Gc = new fn(this, t.P().layout, i, "right"), this.cv.appendChild(this.Gc.Ec()));
    }
  }, t.prototype.mv = function () {
    return cn && null === this.sv;
  }, t.prototype.Nv = function () {
    return cn && this.hv || null !== this.sv;
    ...
    this.hi().Pl(this.Rv(t), this.jv(i), f(this.uv));
  ...
  function t(t, i, n, h) {
    ...
    this.T = !0, this.oc = new Xi(0, 0), this.dc = function () {
      return s.Rc(3);
    }, this.mc = "left" === t, this.ol = n.jl, this.xi = i, this.Uv = h, this.gc = document.createElement("div"), this.gc.style.width = "25px", this.gc.style.height = "100%", this.gc.style.overflow = "hidden", this.pc = tn(this.gc, new Xi(16, 16)), this.pc.subscribeCanvasConfigured(this.dc);
  }
...
var wn = function () {
  function t(t) {
    var i = this;
    this.qv = null, this.Hv = null, this.ne = null, this.Yv = !1, this.oc = new Xi(0, 0), this.dc = function () {
      return i.av.ct().Lr();
    }, this.bc = function () {
      return i.av.ct().Lr();
    }, this.av = t, this.xi = t.P().layout, this.Kv = document.createElement("tr"), this.$v = document.createElement("td"), this.$v.style.padding = "0", this.Xv = document.createElement("td"), this.Xv.style.padding = "0", this.gc = document.createElement("td"), this.gc.style.height = "25px", this.gc.style.padding = "0", this.Zv = document.createElement("div"), this.Zv.style.width = "100%", this.Zv.style.height = "100%", this.Zv.style.position = "relative", this.Zv.style.overflow = "hidden", this.gc.appendChild(this.Zv), this.pc = tn(this.Zv, new Xi(16, 16)), this.pc.subscribeCanvasConfigured(this.dc);
    var n = this.pc.canvas;
    n.style.position = "absolute", n.style.zIndex = "1", n.style.left = "0", n.style.top = "0", this.yc = tn(this.Zv, new Xi(16, 16)), this.yc.subscribeCanvasConfigured(this.bc);
    var h = this.yc.canvas;
    h.style.position = "absolute", h.style.zIndex = "2", h.style.left = "0", h.style.top = "0", this.Kv.appendChild(this.$v), this.Kv.appendChild(this.gc), this.Kv.appendChild(this.Xv), this.Jv(), this.av.ct().So().tn(this.Jv.bind(this), this), this.Ac = new rn(this.yc.canvas, this, {
      xf: !0,
      Nf: !1
    });
  }
  ...
  return t.prototype.an = function () {
    this.Ac.an(), null !== this.qv && this.qv.an(), null !== this.Hv && this.Hv.an(), this.yc.unsubscribeCanvasConfigured(this.bc), this.yc.destroy(), this.pc.unsubscribeCanvasConfigured(this.dc), this.pc.destroy();
  }, t.prototype.Ec = function () {
    return this.Kv;
  }, t.prototype.Gv = function () {
    return this.qv;
    ...
    if (!this.Yv) {
      this.Yv = !0;
      var i = this.av.ct();
      !i.j().Qt() && this.av.P().Xc.$c.time && i.Tl(t.Xf);
    }
  }, t.prototype.Vf = function () {
    var t = this.av.ct();
    !t.j().Qt() && this.Yv && (this.Yv = !1, this.av.P().Xc.$c.time && t.zl());
  }, t.prototype.Sf = function (t) {
    var i = this.av.ct();
    !i.j().Qt() && this.av.P().Xc.$c.time && i.Vl(t.Xf);
  }, t.prototype.Tf = function (t) {
    this.Yv = !1;
    var i = this.av.ct();
    i.j().Qt() && !this.av.P().Xc.$c.time || i.zl();
  }, t.prototype.Af = function () {
    this.av.P().Xc.axisDoubleClickReset && this.av.ct().Ol();
  }, t.prototype.mf = function (t) {
    this.av.ct().P().Xc.$c.time && this.Zc(1);
  }, t.prototype.Uf = function (t) {
    this.Zc(0);
  }, t.prototype.Av = function () {
    return this.oc;
    ...
    this.oc && this.oc.fn(t) || (this.oc = t, this.pc.resizeCanvas({
      ...
      width: t.ht,
      height: t.st
    }), this.gc.style.width = t.ht + "px", this.gc.style.height = t.st + "px"), null !== this.qv && this.qv.Pc(new Xi(i, t.st)), null !== this.Hv && this.Hv.Pc(new Xi(n, t.st));
    ...
    if (0 !== t) {
      ...
      n.clearRect(0, 0, Math.ceil(this.oc.ht * h), Math.ceil(this.oc.st * h)), this.h_([this.av.ct().Nl()], n, h);
    }
  }, t.prototype.Uc = function (t, i) {
    var n = this;
    z(t, i, function () {
      O(t, 0, 0, n.oc.ht, n.oc.st, n.Lv());
    });
  }, t.prototype.uu = function (t, i) {
    if (this.av.P().timeScale.borderVisible) {
    ...
    if (h && 0 !== h.length) {
      ...
      if (this.av.ct().j().P().borderVisible) {
        t.beginPath();
    ...
    for (var h = this.n_(), s = 0, r = t; s < r.length; s++) for (var e = 0, u = r[s].vi(); e < u.length; e++) {
      var a = u[e];
    ...
    return this.av.P().timeScale.borderColor;
  }, t.prototype.ue = function () {
    return this.xi.textColor;
  }, t.prototype.se = function () {
    return this.xi.fontSize;
    ...
    var t = this.av.ct(),
        i = t.P();
    i.leftPriceScale.visible || null === this.qv || (this.$v.removeChild(this.qv.Ec()), this.qv.an(), this.qv = null), i.rightPriceScale.visible || null === this.Hv || (this.Xv.removeChild(this.Hv.Ec()), this.Hv.an(), this.Hv = null);
    var n = {
      jl: this.av.ct().jl()
    };
    ...
    if (i.leftPriceScale.visible && null === this.qv) {
      ...
      this.qv = new _n("left", this.av.P(), n, h), this.$v.appendChild(this.qv.Ec());
    }
    ...
    if (i.rightPriceScale.visible && null === this.Hv) {
      ...
      this.Hv = new _n("right", this.av.P(), n, h), this.Xv.appendChild(this.Hv.Ec());
    }
  }, t;
}(),
    Mn = function () {
  function t(t, i) {
    this.u_ = [], this.a_ = 0, this.zn = 0, this.Hs = 0, this.o_ = 0, this.l_ = 0, this.f_ = null, this.c_ = !1, this.iv = new G(), this.ul = new G(), this.xi = i, this.Kv = document.createElement("div"), this.Kv.classList.add("tv-lightweight-charts"), this.Kv.style.overflow = "hidden", this.Kv.style.width = "100%", this.Kv.style.height = "100%", this.v_ = document.createElement("table"), this.v_.setAttribute("cellspacing", "0"), this.Kv.appendChild(this.v_), this.__ = this.d_.bind(this), this.Kv.addEventListener("wheel", this.__, {
      passive: !1
    }), this.hi = new $i(this.al.bind(this), this.xi), this.ct().Sl().tn(this.w_.bind(this), this), this.M_ = new wn(this), this.v_.appendChild(this.M_.Ec());
    var n = this.xi.width,
        h = this.xi.height;
    ...
    n = Math.max(70, n), h = Math.max(50, h), this.b_(n, h), this.m_(), t.appendChild(this.Kv), this.g_(), this.hi.j().Hr().tn(this.hi._l.bind(this.hi), this), this.hi.So().tn(this.hi._l.bind(this.hi), this);
  }
  ...
  return t.prototype.ct = function () {
    ...
    this.Kv.removeEventListener("wheel", this.__), 0 !== this.a_ && window.cancelAnimationFrame(this.a_), this.hi.Sl().rn(this), this.hi.j().Hr().rn(this), this.hi.So().rn(this), this.hi.an();

    for (var t = 0, i = this.u_; t < i.length; t++) {
      var n = i[t];
      this.v_.removeChild(n.Ec()), n.Dv().rn(this), n.an();
    }

    this.u_ = [], f(this.M_).an(), null !== this.Kv.parentElement && this.Kv.parentElement.removeChild(this.Kv), this.ul.an(), this.iv.an(), delete this.Kv;
  }, t.prototype.b_ = function (t, i, n) {
    if (void 0 === n && (n = !1), this.zn !== i || this.Hs !== t) {
      this.zn = i, this.Hs = t;
      var h = i + "px",
          s = t + "px";
      f(this.Kv).style.height = h, f(this.Kv).style.width = s, this.v_.style.height = h, this.v_.style.width = s, n ? this.y_(new Ut(3)) : this.hi._l();
    }
  }, t.prototype.Rc = function (t) {
    void 0 === t && (t = new Ut(3));

    for (var i = 0; i < this.u_.length; i++) this.u_[i].Rc(t.Ne(i).ke);
    ...
    return z(h, s, function () {
      var n = 0,
        ...
        for (var r = 0; r < t.u_.length; r++) {
          var e = t.u_[r],
              u = e.Av().st,
              a = f("left" === i ? e.Ov() : e.Pv()),
              o = a.Kc();
          h.drawImage(o, n, s, a.Ic(), u), s += u;
        }
      };

      t.x_() && (r("left"), n = f(i.Ov()).Ic()), s = 0;
      ...
      var l = function (i) {
        var r = f("left" === i ? t.M_.Gv() : t.M_.Qv()),
            e = r.Av(),
            u = r.Kc();
      ...
      if (t.xi.timeScale.visible) {
        n = 0, t.x_() && (l("left"), n = f(i.Ov()).Ic());
        var c = t.M_.Av();
        o = t.M_.Kc();
        h.drawImage(o, n, s, c.ht, c.st), t.N_() && (n = i.Av().ht, l("right"), h.restore());
      }
    }), n;
  }, t.prototype.S_ = function (t) {
    return "none" === t ? 0 : ("left" !== t || this.x_()) && ("right" !== t || this.N_()) ? 0 === this.u_.length ? 0 : f("left" === t ? this.u_[0].Ov() : this.u_[0].Pv()).Ic() : 0;
  }, t.prototype.D_ = function () {
    for (var t = 0, i = 0, n = 0, h = 0, s = this.u_; h < s.length; h++) {
      var r = s[h];
      this.x_() && (i = Math.max(i, f(r.Ov()).zc())), this.N_() && (n = Math.max(n, f(r.Pv()).zc())), t += r.Do();
    }

    var e = this.Hs,
        u = this.zn,
        a = Math.max(e - i - n, 0),
        o = this.xi.timeScale.visible ? this.M_.i_() : 0;
    o % 2 && (o += 1);

    for (var l = 0 + o, c = u < l ? 0 : u - l, v = c / t, _ = 0, d = 0; d < this.u_.length; ++d) {
      (r = this.u_[d]).wv(this.hi.yl()[d]);
      var w,
          M = 0;
      M = d === this.u_.length - 1 ? c - _ : Math.round(r.Do() * v), _ += w = Math.max(M, 2), r.Pc(new Xi(a, w)), this.x_() && r.Tv(i, "left"), this.N_() && r.Tv(n, "right"), r.Wc() && this.hi.Dl(r.Wc(), w);
    }

    this.M_.t_(new Xi(a, o), i, n), this.hi.kr(a), this.o_ !== i && (this.o_ = i), this.l_ !== n && (this.l_ = n);
    ...
    var i = this;
    null !== this.f_ ? this.f_.wn(t) : this.f_ = t, this.c_ || (this.c_ = !0, this.a_ = window.requestAnimationFrame(function () {
      i.c_ = !1, i.a_ = 0, null !== i.f_ && (i.y_(i.f_), i.f_ = null);
    }));
    ...
    for (var t = this.hi.yl(), i = t.length, n = this.u_.length, h = i; h < n; h++) {
      var s = l(this.u_.pop());
      this.v_.removeChild(s.Ec()), s.Dv().rn(this), s.an();
    }

    for (h = n; h < i; h++) {
      (s = new vn(this, t[h])).Dv().tn(this.T_.bind(this), this), this.u_.push(s), this.v_.insertBefore(s.Ec(), this.M_.Ec());
    }
...
function Cn(t, i) {
  if (null !== i) {
    ...
    for (var s = Dn.length - 1; s >= 0; --s) if (Math.floor(n.getTime() / Dn[s].V_) !== Math.floor(h.getTime() / Dn[s].V_)) return Dn[s].Os;
  }
  ...
  return t.prototype.an = function () {
    ...
    if (0 !== i.length) {
      ...
      h = i.map(function (i) {
        var h = s(i.time),
            e = n.O_.get(h.Ss);
        void 0 === e && (e = Vn(h), n.O_.set(h.Ss, e));
        var u = r(h, e.zs, i);
    ...
    var s = this.O_.get(n.Ss),
        r = void 0 === s;
    void 0 === s && (s = Vn(n), this.O_.set(n.Ss, s));
    ...
    0 !== i.length ? (this.P_.set(t, i.filter(gn)), this.I_.set(t, i[i.length - 1].V)) : (this.P_.delete(t), this.I_.delete(t));
...
var Wn = function () {
  ...
  return t.prototype.an = function () {
    ...
    return It(this.rd) ? this.sd.S_("left" === this.rd ? "left" : "right") : 0;
  }, t.prototype.Jt = function () {
    return f(this.sd.ct().pl(this.rd)).X;
  }, t;
}(),
    Gn = function () {
  function t(t) {
    this.ed = new G(), this.Qs = new G(), this.hi = t, this.bo().Ur().tn(this.ud.bind(this)), this.bo().qr().tn(this.ad.bind(this));
  }

  return t.prototype.an = function () {
    this.bo().Ur().rn(this), this.bo().qr().rn(this), this.ed.an(), delete this.hi;
...
var ih = function () {
  function t(t, i) {
    var n = this;
    this.od = new zn(), this.ld = new Map(), this.fd = new Map(), this.vd = new G(), this._d = new G();
    var h = void 0 === i ? b(qn) : v(b(qn), th(i));
    this.sd = new Mn(t, h), this.sd.Dv().tn(function (t) {
  ...
  return t.prototype.remove = function () {
    this.sd.Dv().rn(this), this.sd.Sl().rn(this), this.wd.an(), this.sd.an(), delete this.sd, this.ld.forEach(function (t, i) {
      i.an();
    }), this.ld.clear(), this.fd.clear(), this.vd.an(), this._d.an(), this.od.an(), delete this.od;
    ...
    return t = t || this.sd.ct().Kl(), new Jn(this.sd, t);
    ...
    i.Rl(t.j.Dr, t.j.G_), t.K_.forEach(function (t, i) {
      return i.ho(t.Z_, t._l);
    }), i.Er();
  }, t.prototype.bd = function (t) {
    return l(this.fd.get(t));
...
},{"fancy-canvas/coordinate-space":"node_modules/fancy-canvas/coordinate-space.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var chart = (0, _lightweightCharts.createChart)(document.body, {
...
function nextBar() {
  ...
  var old_price = nextBar.bar.close;
  var volatility = 0.1;
  var rnd = Math.random();
...
},{"./styles.css":"src/styles.css","lightweight-charts":"node_modules/lightweight-charts/dist/lightweight-charts.esm.production.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
