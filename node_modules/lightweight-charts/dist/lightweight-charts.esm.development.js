...
var PriceAxisWidget = /** @class */ (function () {
    ...
    PriceAxisWidget.prototype._private__mouseDownEvent = function (e) {
        if (this._private__priceScale === null || this._private__priceScale._internal_isEmpty() || !this._private__pane._internal_chart()._internal_options()._internal_handleScale._internal_axisPressedMouseMove.price) {
            return;
        }
        var model = this._private__pane._internal_chart()._internal_model();
        var pane = this._private__pane._internal_state();
    ...
    PriceAxisWidget.prototype._private__pressedMouseMoveEvent = function (e) {
        if (this._private__priceScale === null || !this._private__pane._internal_chart()._internal_options()._internal_handleScale._internal_axisPressedMouseMove.price) {
            return;
        }
        var model = this._private__pane._internal_chart()._internal_model();
        var pane = this._private__pane._internal_state();
    ...
    PriceAxisWidget.prototype._private__mouseDoubleClickEvent = function (e) {
        if (this._private__pane._internal_chart()._internal_options()._internal_handleScale.axisDoubleClickReset) {
    ...
    PriceAxisWidget.prototype._private__mouseEnterEvent = function (e) {
        ...
        var model = this._private__pane._internal_chart()._internal_model();
        if (model._internal_options()._internal_handleScale._internal_axisPressedMouseMove.price && !this._private__priceScale._internal_isPercentage() && !this._private__priceScale._internal_isIndexedTo100()) {
...
var PaneWidget = /** @class */ (function () {
    function PaneWidget(chart, state) {
        ...
        var scrollOptions = this._internal_chart()._internal_options()._internal_handleScroll;
    ...
    PaneWidget.prototype._internal_pressedMouseMoveEvent = function (event) {
        ...
        var scrollOptions = this._private__chart._internal_options()._internal_handleScroll;
    ...
    PaneWidget.prototype._internal_pinchEvent = function (middlePoint, scale) {
        if (!this._private__chart._internal_options()._internal_handleScale.pinch) {
            return;
        }
...
var TimeAxisWidget = /** @class */ (function () {
    ...
    TimeAxisWidget.prototype._internal_mouseDownEvent = function (event) {
        ...
        if (model._internal_timeScale()._internal_isEmpty() || !this._private__chart._internal_options()._internal_handleScale._internal_axisPressedMouseMove.time) {
            return;
        }
    ...
    TimeAxisWidget.prototype._internal_mouseDownOutsideEvent = function () {
        ...
        if (!model._internal_timeScale()._internal_isEmpty() && this._private__mouseDown) {
            this._private__mouseDown = false;
            if (this._private__chart._internal_options()._internal_handleScale._internal_axisPressedMouseMove.time) {
    ...
    TimeAxisWidget.prototype._internal_mouseDoubleClickEvent = function () {
        if (this._private__chart._internal_options()._internal_handleScale.axisDoubleClickReset) {
    ...
    TimeAxisWidget.prototype._internal_mouseEnterEvent = function (e) {
        if (this._private__chart._internal_model()._internal_options()._internal_handleScale._internal_axisPressedMouseMove.time) {
...
var ChartWidget = /** @class */ (function () {
    ...
    ChartWidget.prototype._private__onMousewheel = function (event) {
        ...
        if ((deltaX === 0 || !this._private__options._internal_handleScroll.mouseWheel) &&
            (deltaY === 0 || !this._private__options._internal_handleScale.mouseWheel)) {
            return;
        }
        if (event.cancelable) {
            event.preventDefault();
        ...
        if (deltaY !== 0 && this._private__options._internal_handleScale.mouseWheel) {
...
var chartOptionsDefaults = {
    ...
    _internal_handleScroll: {
        mouseWheel: true,
        pressedMouseMove: true,
        horzTouchDrag: true,
        vertTouchDrag: true,
    },
    _internal_handleScale: {
        _internal_axisPressedMouseMove: {
            time: true,
            price: true,
        },
